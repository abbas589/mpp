package com.miu.mpp.lab9.partii.q7;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		ordering1(intList);
		List<String> stringList = Arrays.asList("cba", "efg", "doe", "fie", "set", "bbd","aez");
	...
	public static void ordering1(List<Integer> list) {
		...
		System.out.println(list.stream().sorted(Comparator.comparing(integerFunction).thenComparing(Integer::intValue)).collect(Collectors.toList()));
	...
	public static void ordering2(List<String> words) {
		...
		Function<String, String> reverseString = (v)-> new StringBuilder(v).reverse().toString();

		System.out.println(words.stream().sorted(Comparator.comparing(reverseString).thenComparing(Object::toString)).collect(Collectors.toList()));
